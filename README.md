...
Le back nécessite un fichier de secrets. Veuillez indiquer les variables dans le fichier application.properties.
...
Les tests nécessitent un fichier de secrets. Veuillez indiquer les variables dans le fichier application-test.properties.
